...
public class ProgressionLeconService {
    ...
    /** IDs des leçons marquées complètes pour cet apprenant sur ce cours */
    public Set<Long> completedLeconIds(Long apprenantId, Long coursId) {
        return new HashSet<>(progressionLeconRepository.findCompletedLeconIds(apprenantId, coursId));
    }
}
